...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/expose.js", error: String((e && e.message) || e) }); }
 ...
 */
function registerStrings(locale, table) {
...
Object.assign(__ds_scope, { LOCALES, CATALOGUE, registerStrings });
...
const I18n = {
  t,
  has,
  registerStrings: __ds_scope.registerStrings,
  languageName: __ds_scope.languageName,
  Locale,
  LOCALES: __ds_scope.LOCALES,
  CATALOGUE: __ds_scope.CATALOGUE
};
__ds_scope.expose({
  t,
  has,
...
Object.assign(__ds_scope, { registerStrings: __ds_scope.registerStrings, Locale, t, has, I18n });
